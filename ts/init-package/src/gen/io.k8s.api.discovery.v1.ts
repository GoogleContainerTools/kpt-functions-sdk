...
export class Endpoint {
  ...
  public deprecatedTopology?: {[key: string]: string};

  // hints contains information associated with how an endpoint should be consumed.
  public hints?: EndpointHints;
  ...
  constructor(desc: Endpoint) {
    ...
    this.deprecatedTopology = desc.deprecatedTopology;
    this.hints = desc.hints;
...
export namespace EndpointSlice {
  export const apiVersion = "discovery.k8s.io/v1";
