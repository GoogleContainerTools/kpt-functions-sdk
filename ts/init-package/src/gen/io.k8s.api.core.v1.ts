...
export class CSIPersistentVolumeSource {
  ...
  public controllerExpandSecretRef?: SecretReference;
  ...
  constructor(desc: CSIPersistentVolumeSource) {
    this.controllerExpandSecretRef = desc.controllerExpandSecretRef;
...
export class Container {
  ...
  constructor(desc: Container) {
    ...
    this.startupProbe = desc.startupProbe;
...
export class EndpointPort {
  ...
  constructor(desc: EndpointPort) {
    this.appProtocol = desc.appProtocol;
    this.name = desc.name;
    this.port = desc.port;
    this.protocol = desc.protocol;
  }
...
export class EphemeralContainer {
  ...
  public targetContainerName?: string;
  ...
  constructor(desc: EphemeralContainer) {
    this.args = desc.args;
    this.command = desc.command;
    this.env = desc.env;
    this.envFrom = desc.envFrom;
    ...
    this.stdin = desc.stdin;
    this.stdinOnce = desc.stdinOnce;
    this.targetContainerName = desc.targetContainerName;
    this.terminationMessagePath = desc.terminationMessagePath;
    this.terminationMessagePolicy = desc.terminationMessagePolicy;
    this.tty = desc.tty;
    this.volumeDevices = desc.volumeDevices;
...
export class EphemeralContainers implements KubernetesObject {
  // APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  public apiVersion: string;
  ...
  public ephemeralContainers: EphemeralContainer[];
  ...
  constructor(desc: EphemeralContainers.Interface) {
    this.apiVersion = EphemeralContainers.apiVersion;
    this.ephemeralContainers = desc.ephemeralContainers;
    this.kind = EphemeralContainers.kind;
    this.metadata = desc.metadata;
  }
}

export function isEphemeralContainers(o: any): o is EphemeralContainers {
  return o && o.apiVersion === EphemeralContainers.apiVersion && o.kind === EphemeralContainers.kind;
}
...
export namespace EphemeralContainers {
  ...
  export const group = "";
  export const version = "v1";
  export const kind = "EphemeralContainers";
...
export class EphemeralVolumeSource {
  ...
  public volumeClaimTemplate?: PersistentVolumeClaimTemplate;
}
...
export class LimitRangeItem {
  ...
  constructor(desc: LimitRangeItem) {
    this.default = desc.default;
    this.defaultRequest = desc.defaultRequest;
    this.max = desc.max;
    this.maxLimitRequestRatio = desc.maxLimitRequestRatio;
    this.min = desc.min;
    this.type = desc.type;
  }
}
...
export class NamespaceCondition {
  ...
  constructor(desc: NamespaceCondition) {
...
export class NamespaceStatus {
  ...
  public conditions?: NamespaceCondition[];
...
export class PersistentVolumeClaimTemplate {
  ...
  constructor(desc: PersistentVolumeClaimTemplate) {
    this.metadata = desc.metadata;
    this.spec = desc.spec;
  }
}
...
export class PodSecurityContext {
  ...
  public fsGroupChangePolicy?: string;
  ...
  public windowsOptions?: WindowsSecurityContextOptions;
}
...
export class PodSpec {
  ...
  public setHostnameAsFQDN?: boolean;
  ...
  public topologySpreadConstraints?: TopologySpreadConstraint[];
  ...
  constructor(desc: PodSpec) {
    ...
    this.preemptionPolicy = desc.preemptionPolicy;
    ...
    this.setHostnameAsFQDN = desc.setHostnameAsFQDN;
    ...
    this.topologySpreadConstraints = desc.topologySpreadConstraints;
...
export class PodStatus {
  ...
  public ephemeralContainerStatuses?: ContainerStatus[];
...
export class SeccompProfile {
  ...
  public localhostProfile?: string;
  ...
  constructor(desc: SeccompProfile) {
    this.localhostProfile = desc.localhostProfile;
    this.type = desc.type;
  }
}
...
export class ServiceSpec {
  ...
  public allocateLoadBalancerNodePorts?: boolean;
  ...
  public internalTrafficPolicy?: string;
  ...
  public loadBalancerClass?: string;
...
export class TopologySpreadConstraint {
  ...
  public whenUnsatisfiable: string;

  constructor(desc: TopologySpreadConstraint) {
    this.labelSelector = desc.labelSelector;
    this.maxSkew = desc.maxSkew;
    this.topologyKey = desc.topologyKey;
    this.whenUnsatisfiable = desc.whenUnsatisfiable;
  }
}
...
export class Volume {
  ...
  public ephemeral?: EphemeralVolumeSource;
...
export class WindowsSecurityContextOptions {
  ...
  public gmsaCredentialSpec?: string;

  // GMSACredentialSpecName is the name of the GMSA credential spec to use.
  public gmsaCredentialSpecName?: string;
