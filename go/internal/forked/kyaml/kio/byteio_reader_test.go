...
`,
			...
			wrappingAPIKind:    kio.ResourceListKind,
		},
...
`,
			...
			instance: kio.ByteReader{OmitReaderAnnotations: true},
		},
...
`},
	...
	for n := range testCases {
		...
		t.Run(n, func(t *testing.T) {
			rNodes, err := kio.FromBytes(tc.input)
			if err != nil {
