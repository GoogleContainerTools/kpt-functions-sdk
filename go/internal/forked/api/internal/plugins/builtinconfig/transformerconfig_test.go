...
func TestMakeDefaultConfig(t *testing.T) {
	...
	_ = builtinconfig.MakeDefaultConfig()
}

func TestAddNamereferenceFieldSpec(t *testing.T) {
	cfg := &builtinconfig.TransformerConfig{}
...
func TestMerge(t *testing.T) {
	nameReference := []builtinconfig.NameBackReferences{
		{
			Gvk: resid.Gvk{
				Kind: "KindA",
			},
	...
	expected := &builtinconfig.TransformerConfig{}
