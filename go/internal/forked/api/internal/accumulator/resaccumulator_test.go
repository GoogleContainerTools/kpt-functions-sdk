...
func makeResAccumulator(t *testing.T) *accumulator.ResAccumulator {
...
func TestResolveVarConflicts(t *testing.T) {
	...
	ac0 := accumulator.MakeEmptyAccumulator()
	...
	require.NoError(t, err)
	ac1 := accumulator.MakeEmptyAccumulator()
	...
	require.NoError(t, err)
	ac2 := accumulator.MakeEmptyAccumulator()
...
func TestResolveVarsWithNoambiguation(t *testing.T) {
	...
	ra2 := accumulator.MakeEmptyAccumulator()
