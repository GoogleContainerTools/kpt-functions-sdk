...
func TestIdSet_Empty(t *testing.T) {
	s := resource.MakeIdSet([]*resource.Resource{})
...
func TestIdSet_One(t *testing.T) {
	s := resource.MakeIdSet([]*resource.Resource{testDeployment})
...
func TestIdSet_Two(t *testing.T) {
	s := resource.MakeIdSet([]*resource.Resource{testDeployment, testConfigMap})
